...
def test_generate_attack_resnet50_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_resnet50")
    
    assert adv_images is not None

def test_generate_attack_densenet_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_densenet")
    
    assert adv_images is not None
    
def test_generate_attack_efficientnet_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_efficientnet")
    
    assert adv_images is not None

def test_generate_attack_inceptionv3_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_inceptionv3")
    
    assert adv_images is not None

def test_generate_attack_vgg16_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_vgg16")
    
    assert adv_images is not None

def test_generate_attack_vgg19_UAP():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "UAP_vgg19")
