...
def test_generate_attack_resnet50_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_resnet50")
    
    assert adv_images is not None

def test_generate_attack_densenet_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_densenet")
    
    assert adv_images is not None
    
def test_generate_attack_efficientnet_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_efficientnet")
    
    assert adv_images is not None

def test_generate_attack_inceptionv3_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_inceptionv3")
    
    assert adv_images is not None

def test_generate_attack_vgg16_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_vgg16")
    
    assert adv_images is not None

def test_generate_attack_vgg19_PGD():
    ...
    load_dataset.show_random_adv_image(adv_images, dataset_name, "PGD_vgg19")
